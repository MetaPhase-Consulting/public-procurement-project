...
const Footer: React.FC = () => {
    return (
  <>
    <footer className={['site-footer footer', classes.FooterWrapper].join(' ')}>
        ...
        <span className="followus">
          follow us
            ...
            <section className="module module--front-page-social-media front-page-social-media"
              ...
              <div className="frame">
                <a href="https://www.facebook.com/statedept" className="icon fab fa-facebook-f" target="_blank"
                   aria-label="State Department on Facebook">
              <span className="screen-reader-text">
                Facebook
              </span>
                </a>
                <a href="https://twitter.com/StateDept" className="icon fab fa-twitter" target="_blank"
                   aria-label="State Department on Twitter">
              <span className="screen-reader-text">
                Twitter
              </span>
                </a>
                <a href="https://www.instagram.com/statedept/" className="icon fab fa-instagram" target="_blank"
                   aria-label="State Department on Instagram">
              <span className="screen-reader-text">
                Instagram
              </span>
                </a>
                <a href="https://www.youtube.com/user/statevideo" className="icon fab fa-youtube" target="_blank"
                   aria-label="State Department on YouTube">
              <span className="screen-reader-text">
                YouTube
              </span>
                </a>
                <a href="https://www.flickr.com/photos/statephotos/" className="icon fab fa-flickr" target="_blank"
                   aria-label="State Department on Flickr">
              <span className="screen-reader-text">
                Flickr
              </span>
                </a>
                <a href="https://www.state.gov/department-email-updates/" className="icon fas fa-envelope"
                   target="_blank" aria-label="State Department on GovDelivery">
              <span className="screen-reader-text">
                GovDelivery
              </span>
                </a>
