                    ...
                    <div className="nav__utility-content">
                        ...
                        <div className="social_links_header">
                            <section className="module module--front-page-social-media front-page-social-media" aria-label="Social Media" role="group">
                                <div className="frame">
                                    <a href="https://www.facebook.com/statedept" className="icon fab fa-facebook-f" target="_blank" aria-label="State Department on Facebook" rel="noreferrer">
                                        <span className="screen-reader-text"> Facebook </span>
                                    </a>
                                    <a href="https://twitter.com/StateDept" className="icon fab fa-twitter" target="_blank" aria-label="State Department on Twitter" rel="noreferrer">
                                        <span className="screen-reader-text"> Twitter </span>
                                    </a>
                                    <a href="https://www.instagram.com/statedept/" className="icon fab fa-instagram" target="_blank" aria-label="State Department on Instagram" rel="noreferrer">
                                        <span className="screen-reader-text"> Instagram </span>
                                    </a>
                                    <a href="https://www.youtube.com/user/statevideo" className="icon fab fa-youtube" target="_blank" aria-label="State Department on YouTube" rel="noreferrer">
                                        <span className="screen-reader-text"> YouTube </span>
                                    </a>
                                    <a href="https://www.flickr.com/photos/statephotos/" className="icon fab fa-flickr" target="_blank" aria-label="State Department on Flickr" rel="noreferrer">
                                        <span className="screen-reader-text"> Flickr </span>
                                    </a>
                                    <a href="https://www.state.gov/department-email-updates/" className="icon fas fa-envelope" target="_blank" aria-label="State Department on GovDelivery" rel="noreferrer">
