...
const Home: NextPage = () => {
    ...
    return (
        <Layout title="Forecast Tool Home" darkHeader className='homepage'>
                ...
                <GridContainer className="max-w-none p-1">
                    <Grid row gap="lg">
                        <Grid tablet={{ col: 12 }} desktop={{ col: 5 }} className='pb-20 m-auto'>
                            <Link className='browse-cta' href='/forecast'>
                                <div className='browse-cta-icon'>
                                ...
                                <span className='browse-cta-label'>Browse Opportunities</span>
                            </Link>
                        </Grid>
                        ...
                        <Grid tablet={{ col: 12 }} desktop={{ col: 7 }} className='pb-20'>
                            <div className='featured-widget'>
                                ...
                                <div className='widget-content'>
                                    {data && data.map((o, i) => {
                                        return (
                                            <Link key={i} className='widget-item' href={'/forecast/' + convertNumber(o.number)}>
                        ...
                        <Grid tablet={{ col: 12 }} desktop={{ col: 5 }} className='pb-20'>
                            <div className='announcement-widget p-10'>
                        ...
                        <Grid tablet={{ col: 7 }} desktop={{ col: 8 }}>
                            ...
                            <div className='message-content pr-5'>
                                {longText}
                            </div>
                        </Grid>
                        <Grid
